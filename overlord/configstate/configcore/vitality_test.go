...
func (s *vitalitySuite) TestConfigureVitalityWithValidSnapUC16LegacySystemd(c *C) {
...
func (s *vitalitySuite) TestConfigureVitalityWithValidSnapUC16ModernSystemd(c *C) {
...
func (s *vitalitySuite) TestConfigureVitalityWithValidSnapUC18LegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *vitalitySuite) TestConfigureVitalityWithValidSnapUC18ModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *vitalitySuite) testConfigureVitalityWithQuotaGroupLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *vitalitySuite) testConfigureVitalityWithQuotaGroupModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *vitalitySuite) TestConfigureVitalityWithQuotaGroupDaemonReloadLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *vitalitySuite) TestConfigureVitalityWithQuotaGroupDaemonReloadModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
