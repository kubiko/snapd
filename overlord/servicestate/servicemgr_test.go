...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesSimpleWritesServicesFilesUC16LegacySystemd(c *C) {
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesSimpleWritesServicesFilesUC16ModernSystemd(c *C) {
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesUC18LegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesUC1ModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesUC18DaemonReloadLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesUC18DaemonReloadModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesVitalityRankUC18LegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesVitalityRankUC18ModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesVitalityRankUC18DaemonReloadLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesVitalityRankUC18DaemonReloadModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesAndDoesNotRestartIfBootTimeAfterModTimeLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesAndDoesNotRestartIfBootTimeAfterModTimeModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesAndIgnoresBootTimeErrorsLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesAndIgnoresBootTimeErrorsModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesAndRestartsLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesAndRestartsModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesButDoesNotRestartDisabledServicesLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesButDoesNotRestartDisabledServicesModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesDoesNotRestartServicesKilledBeforeSnapdRefreshLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesDoesNotRestartServicesKilledBeforeSnapdRefreshModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesDoesNotRestartServicesKilledAfterSnapdRefreshLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesDoesNotRestartServicesKilledAfterSnapdRefreshModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesSimpleRewritesServicesFilesAndRestartsTimePrecisionSillyLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesSimpleRewritesServicesFilesAndRestartsTimePrecisionSillyModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesSimpleRewritesServicesFilesAndRestartsTimePrecisionMoreSillyLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesSimpleRewritesServicesFilesAndRestartsTimePrecisionMoreSillyModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesSimpleRewritesServicesFilesAndRestartsUC18LegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesDoesNotRestartServicesWhenUsrLibSnapdWasNeverInactiveLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesDoesNotRestartServicesWhenUsrLibSnapdWasNeverInactiveModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesAndRestartsButThenFallsbackToRebootLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesAndRestartsButThenFallsbackToRebootModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesAndTriesRestartButFailsButThenFallsbackToRebootLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *ensureSnapServiceSuite) TestEnsureSnapServicesWritesServicesFilesAndTriesRestartButFailsButThenFallsbackToRebootModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
