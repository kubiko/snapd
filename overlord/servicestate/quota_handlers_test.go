...
func (s *quotaHandlersSuite) TestDoQuotaControlCreateRestartOKLegacySystemd(c *C) {
...
func (s *quotaHandlersSuite) TestDoQuotaControlCreateRestartOKModernSystemd(c *C) {
...
func (s *quotaHandlersSuite) TestQuotaStateAlreadyUpdatedBehaviorLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestQuotaStateAlreadyUpdatedBehaviorModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestDoQuotaControlCreateLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestDoQuotaControlCreateModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestDoQuotaControlUpdateLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestDoQuotaControlUpdateModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestDoQuotaControlUpdateRestartOKLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestDoQuotaControlUpdateRestartOKModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestDoQuotaControlRemoveLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestDoQuotaControlRemoveModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestDoQuotaControlRemoveRestartOKLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestDoQuotaControlRemoveRestartOKModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestQuotaCreateLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestQuotaCreateModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestDoCreateSubGroupQuotaLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestDoCreateSubGroupQuotaModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestDoQuotaRemoveLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestQuotaRemoveModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestQuotaUpdateSubGroupTooBigLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestQuotaUpdateSubGroupTooBigModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestQuotaUpdateChangeMemLimitLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestQuotaUpdateChangeMemLimitModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestQuotaUpdateAddSnapLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestQuotaUpdateAddSnapModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestQuotaUpdateAddSnapAlreadyInOtherGroupLegacySystemd(c *C) {
	releaseRestore := release.MockOnClassic(true)
	defer releaseRestore()
...
func (s *quotaHandlersSuite) TestQuotaUpdateAddSnapAlreadyInOtherGroupModernSystemd(c *C) {
	releaseRestore := release.MockOnClassic(false)
	defer releaseRestore()
